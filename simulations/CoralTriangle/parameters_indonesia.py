...
bw_centrality_sorted = np.load("./Indonesia/input/Indonesia_bet_central_sorted.npy")
egvec_centrality_sorted = np.load("./Indonesia/input/Indonesia_egvec_centrality_sorted.npy")
even_space = np.load("./Indonesia/input/Indo_even_space.npy")
...
beta = np.array([[0.0,0.0]]) #beta = 0, 0.01, 0.1
region = "CT"
